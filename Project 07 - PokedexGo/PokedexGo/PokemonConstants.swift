...
let pokemons = [
  Pokemon(name: "妙蛙种子", id: 1,
    ...
    weak: [PokeType.fire(power: "burn you"), PokeType.flying, PokeType.ice, PokeType.psychic],
  ...
  Pokemon(name: "妙蛙草", id: 2,
    ...
    type: [PokeType.grass, PokeType.poison],
    weak: [PokeType.fire(power: "burn him"), PokeType.flying, PokeType.ice, PokeType.psychic],
  ...
  Pokemon(name: "妙蛙花", id: 3,
    ...
    type: [PokeType.grass, PokeType.poison],
    weak: [PokeType.fire(power: "burn them"), PokeType.flying, PokeType.ice, PokeType.psychic],
  ...
  Pokemon(name: "小火龙", id: 4,
    ...
    type: [PokeType.fire(power: "burn everything")],
  ...
  Pokemon(name: "火恐龙", id: 5,
    ...
    type: [PokeType.fire(power: "burn her")],
    weak: [PokeType.ground, PokeType.rock, PokeType.water],
  ...
  Pokemon(name: "喷火龙", id: 6,
    ...
    type: [PokeType.fire(power: "burn it"), PokeType.flying],
  ...
  Pokemon(name: "绿毛虫", id: 10,
    ...
    type: [PokeType.bug],
    weak: [PokeType.electric, PokeType.flying, PokeType.rock],
  ...
  Pokemon(name: "巴大蝶", id: 12,
    ...
    weak: [PokeType.water, PokeType.flying, PokeType.rock, PokeType.electric, PokeType.ice],
  ...
  Pokemon(name: "独角虫", id: 13,
    ...
    weak: [PokeType.water, PokeType.flying, PokeType.rock, PokeType.psychic],
  ...
  Pokemon(name: "铁壳蛹", id: 14,
    ...
    type: [PokeType.bug, PokeType.poison],
    weak: [PokeType.electric, PokeType.flying, PokeType.rock, PokeType.psychic],
  ...
  Pokemon(name: "大针蜂", id: 15,
    ...
    type: [PokeType.bug, PokeType.poison],
    weak: [PokeType.ice, PokeType.flying, PokeType.rock, PokeType.psychic],
